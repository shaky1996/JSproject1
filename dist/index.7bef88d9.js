...
function fetchPlayers() {
    fetch(API_ENDPOINT).then((response)=>response.json()).then((data)=>displayPlayers(data)).catch((error)=>console.error("Error fetching data:", error));
}
...
//# sourceMappingURL=index.7bef88d9.js.map
